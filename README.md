...
When deploying under a GitHub repository subpath (e.g. `https://<username>.github.io/little-roses-academy/`):

```bash
# Set your repository name as the base URL during build
VITE_BASE_URL=/little-roses-academy/ npm run build
```

---

## 🔗 Connecting & Pushing to GitHub (LITTLE ROSES ACADEMY)

To push this current version to the **LITTLE ROSES ACADEMY** repository:
...
git commit -m "feat: Little Roses Academy v2.0.0 production release"
